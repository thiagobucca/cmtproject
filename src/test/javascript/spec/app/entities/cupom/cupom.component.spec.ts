...
import { CupomComponent } from 'app/entities/cupom/cupom.component';
import { CupomService } from 'app/entities/cupom/cupom.service';
import { Cupom } from 'app/shared/model/cupom.model';

describe('Component Tests', () => {
    describe('Cupom Management Component', () => {
        let comp: CupomComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CupomComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.cupoms[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
