...
describe('Service Tests', () => {
    describe('Membro Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MembroService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Membro(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Membro', async () => {
            ...
            it('should update a Membro', async () => {
                const returnedFromService = Object.assign(
                    {
                        nome: 'BBBBBB'
                    },
            ...
            it('should return a list of Membro', async () => {
                const returnedFromService = Object.assign(
                    {
                        nome: 'BBBBBB'
                    },
