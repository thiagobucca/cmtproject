...
import com.cmt.myapp.service.dto.PasswordChangeDTO;
import com.cmt.myapp.service.dto.UserDTO;
import com.cmt.myapp.web.rest.errors.*;
import com.cmt.myapp.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResource {
    ...
    public void saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        userService.updateUser(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(),
            userDTO.getLangKey(), userDTO.getImageUrl(), userDTO.getPlacet());
    }
