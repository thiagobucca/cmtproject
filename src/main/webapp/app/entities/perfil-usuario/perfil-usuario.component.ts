...
export class PerfilUsuarioComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.perfilUsuarioService
            ...
            .subscribe(
                (res: HttpResponse<IPerfilUsuario[]>) => this.paginatePerfilUsuarios(res.body, res.headers),
    ...
    private paginatePerfilUsuarios(data: IPerfilUsuario[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.perfilUsuarios = data;
    }
