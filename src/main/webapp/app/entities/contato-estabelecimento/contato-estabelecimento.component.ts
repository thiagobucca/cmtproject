...
export class ContatoEstabelecimentoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.contatoEstabelecimentoService
            .query({
                page: this.page - 1,
            ...
            .subscribe(
                (res: HttpResponse<IContatoEstabelecimento[]>) => this.paginateContatoEstabelecimentos(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/contato-estabelecimento'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateContatoEstabelecimentos(data: IContatoEstabelecimento[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.contatoEstabelecimentos = data;
    }
