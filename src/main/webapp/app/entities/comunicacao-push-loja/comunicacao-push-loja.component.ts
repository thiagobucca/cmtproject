...
export class ComunicacaoPushLojaComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.comunicacaoPushLojaService
            .query({
                page: this.page - 1,
            ...
            .subscribe(
                (res: HttpResponse<IComunicacaoPushLoja[]>) => this.paginateComunicacaoPushLojas(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/comunicacao-push-loja'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateComunicacaoPushLojas(data: IComunicacaoPushLoja[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.comunicacaoPushLojas = data;
    }
